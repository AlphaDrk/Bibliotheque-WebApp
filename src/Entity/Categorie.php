...
class Categorie
{
    ...
    private ?string $destignation = null;
    ...
    public function getDestignation(): ?string
    {
        return $this->destignation;
    }

    public function setDestignation(string $destignation): static
    {
