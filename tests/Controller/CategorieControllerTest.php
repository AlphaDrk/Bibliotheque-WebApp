...
final class CategorieControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'categorie[destignation]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setDestignation('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'categorie[destignation]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDestignation());
    }
